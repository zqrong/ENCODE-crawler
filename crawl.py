                        ...
                        if 'files' in experiment.keys():
                            ...
                            for file in tqdm(files, desc='files', position=3, leave=False):
                                ...
                                record = {
                                    ...
                                    'experiment_accession': experiment.get('accession', None),
                                    'cell_line': experiment.get('biosample_ontology', None)['term_name'],
                                    'target': experiment.get('target', None)['label'],
                                    'assay_term_name': experiment.get('assay_term_name', None),
                                    'lab': experiment.get('lab', None)['title'],
